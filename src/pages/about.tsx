...
export default function AboutPage() {
    ...
    <main>
        ...
        <Tooltip title="Follow me on GitHub!" animation="shift" theme="light"><Link href="https://github.com/AdemCanCertel/" target="_blank">
        ...
        <Tooltip title="Join my Discord server!" animation="shift" theme="light"><Link href="https://discord.gg/dwgkB4hua2" target="_blank">
        ...
        <Tooltip title="Follow me on Instagram!" animation="shift" theme="light"><Link href="https://instagram.com/ademcancertel_/" target="_blank">
        ...
        <Tooltip title="Send me an e-mail!" animation="shift" theme="light"><Link href="mailto:ademcancertel619@gmail.com">
        ...
        <div className="full-container mt-16">
            <div className="mt-4">
                ...
                <p className="mt-2">
                The code editor I always use <Link className="vsc" href="https://code.visualstudio.com/">Visual Studio Code</Link>
                <div className="mt-2 space-y-2 underline">
                        <div className="flex flex-row p-4 bg-gray-900 rounded-lg border border-gray-800 w-full text-left space-x-2">
                            <li className="square list-none"><Link href="https://marketplace.visualstudio.com/items?itemName=akamud.vscode-theme-onedark" className="extensions"><Tooltip title="Click Me!" animation="scale">Atom Dark Theme</Tooltip></Link></li>
                        </div>
                        <div className="flex flex-row p-4 bg-gray-900 rounded-lg border border-gray-800 w-full text-left space-x-2">
                            <li className="list-none"><Link className="extensions" href="https://marketplace.visualstudio.com/items?itemName=sdras.night-owl"><Tooltip title="Click Me!" animation="scale">Night Owl</Tooltip></Link></li>
                        </div>
                        <div className="flex flex-row p-4 bg-gray-900 rounded-lg border border-gray-800 w-full text-left space-x-2">
                            <li className="list-none"><Link className="extensions" href="https://marketplace.visualstudio.com/items?itemName=bradlc.vscode-tailwindcss"><Tooltip title="Click Me!" animation="scale">TailwindCSS IntelliSense</Tooltip></Link></li>
                        </div>
                        <div className="flex flex-row p-4 bg-gray-900 rounded-lg border border-gray-800 w-full text-left space-x-2">
                            <li  className="list-none"><Link className="extensions" href="https://marketplace.visualstudio.com/items?itemName=cirlorm.mobileview"><Tooltip title="Click Me!" animation="scale">MobileView</Tooltip></Link></li>
                        </div>    
                </div>
                ...
                <div className="mt-2 space-y-2 underline">
                    <div className="flex flex-row p-4 bg-gray-900 rounded-lg border border-gray-800 w-full text-left space-x-2">
                        ...
                        <li className="square list-none"><Link href="" className="extensions"><Tooltip title="Click Me!" animation="scale">Figma</Tooltip></Link></li>
                    </div>
                    <div className="flex flex-row p-4 bg-gray-900 rounded-lg border border-gray-800 w-full text-left space-x-2">
                        ...
                        <li className="square list-none"><Link href="" className="extensions"><Tooltip title="Click Me!" animation="scale">GitHub Desktop</Tooltip></Link></li>
                    </div>
                    <div className="flex flex-row p-4 bg-gray-900 rounded-lg border border-gray-800 w-full text-left space-x-2">
                        <img src="https://cdn-images-1.medium.com/max/184/1*eT1vA87AVmUeujURPbFObg@2x.png" className="w-12 h-12" />
                        <li className="square list-none"><Link href="" className="extensions"><Tooltip title="Click Me!" animation="scale">ProtoPie</Tooltip></Link></li>
                    </div>
                    <div className="flex flex-row p-4 bg-gray-900 rounded-lg border border-gray-800 w-full text-left space-x-2">
                        ...
                        <li className="square list-none"><Link href="" className="extensions"><Tooltip title="Click Me!" animation="scale">Google Chrome</Tooltip></Link></li>
                    </div>
                </div>
                </p>
            </div>
